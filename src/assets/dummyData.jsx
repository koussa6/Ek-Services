...
export const styles = {
  ...
  logoText: 'text-2xl font-bold text-amber-100 tracking-wide cursor-pointer',
...
export const tableClasses = {
  wrapper: 'overlfow-x-auto',
  table: ' w-full table-auto',
  headerRow: 'bg-[#3a2b2b]/50 sm:text-xs md:text-lg',
  headerCell: 'p-4 text-left sm:text-xs md:text-lg text-amber-400',
