...
const AboutPage = () => {
          ...
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-[#3c2a21]/90 backdrop-blur-lg overflow-hidden rounded-3xl border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-br from-[#1a120b] via-transparent to-transparent"></div>
                  </div>
                  <div className="p-8">
                    <motion.div
                    ...
                    >
                      <Icon className="text-amber-500 w-12 h-12" />
                    </motion.div>
          ...
          {stats.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                animate={{
                  scale: hoveredStats === i ? 1.05 : 1,
                  zIndex: hoveredStats === i ? 10 : 1,
                }}
              >
                <motion.div
  ...
  rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300"
    ...
    shadow-amber-900/20"
                  ...
                  <div className="relative z-10 h-full flex flex-col items-center justify-center">
                    <motion.div
                      className="mb-4 p-3 rounded-full bg-amber-900/30 border border-amber-600/30"
  ...
  text-amber-100/80"
                      animate={{
                        letterSpacing: hoveredStats === i ? '0.15em' : '0.1em',
                        textShadow:
                          hoveredStats === i
                  ...
                  <motion.div
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: hoveredStats === i ? 1 : 0 }}
                  />
                </div>
                <motion.div
                  className="absolute inset-x-4 bottom-0 h-8 bg-amber-900/30 blur-xl rounded-full"
                  animate={{
                    opacity: hoveredStats === i ? 0.4 : 0.2,
                    scale: hoveredStats === i ? 0.9 : 0.8,
                  }}
                />
              </motion.div>
            );
      ...
      <section className="py-16 px-4 md:px-8 relative">
        <div className="max-w-7xl mx-auto">
          {/* Section Header (from image_dcbf87.jpg and Screenshot 2025-12-05 104802.jpg) */}
          <motion.h2
          ...
          {/* Grid Container for Team Members (from image_dcbf87.jpg and Screenshot 2025-12-05 104802.jpg) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
            {/* Team Member Mapping - Placeholder */}
            {teamMembers.map((m, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                <div
                  className="relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl overflow-hidden
